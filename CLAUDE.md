...
- New Swift files under App/ or Packages/*/Sources are NOT in the target until you run xcodegen generate and commit the regenerated JournalInsight.xcodeproj/project.pbxproj — a build can "succeed" while silently excluding them.
